...
include InvokeNativeFunctionDll.inc
...
;------------------------------------------------------------------------------
; SacaraVm example calling exported vm functions in SacaraVm.dll
;------------------------------------------------------------------------------
DoVMStuff PROC
    ...
    ; Get pointers to required parameters for later pushing as arguments
    lea eax, hello_world
    mov ptrHelloWorld, eax
    lea eax, VMCODE
    mov ptrVMCODE, eax
    lea eax, CTX
    mov ptrCTX, eax
